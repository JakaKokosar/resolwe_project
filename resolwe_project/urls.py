...
from resolwe_project.base import views as base_views
from resolwe_project.uploader import views as uploader_views
...
urlpatterns = [  # pylint: disable=invalid-name
    url(r'^api/base/', include('resolwe_project.base.urls')),
