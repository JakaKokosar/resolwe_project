"""
Django settings for the Resolwe project.
...
ROOT_URLCONF = 'resolwe_project.urls'
...
WSGI_APPLICATION = 'resolwe_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'resolwe-project',
        'USER': 'resolwe-project',
        'HOST': 'localhost',
        'PORT': 55432,
        'CONN_MAX_AGE': 0,
        'OPTIONS': {
...
manager_prefix = 'resolwe-project.manager'
FLOW_MANAGER = {
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_FILTER_BACKENDS': (
        ...
        'resolwe_project.base.filters.JsonOrderingFilter',
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'ROUTING': 'resolwe_project.routing.channel_routing',
        'CONFIG': {
